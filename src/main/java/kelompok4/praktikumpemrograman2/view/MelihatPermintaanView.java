...
public class MelihatPermintaanView extends JFrame {
    ...
    public MelihatPermintaanView() {
        ...
        try {
            ...
            List<PermintaanPenjemputan> records = mapper.getAllPermintaan();
            String[][] datas = new String[records.size()][4];
            int i=0;
            ...
            for (PermintaanPenjemputan entity : records) {
                ...
                datas[i][3]= currencyFormatter.format(entity.getHarga());//String.format("%.2f",entity.getHarga());
                i++;
            }
            setPickupData(datas);
        } finally {
